...
module.exports.run = async (bot, message) => {
  try {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(`Destek Sunucusu`, `[Tıkla!](https://discord.gg/WyWZRGY2Ry)`, true)
      .addField(
        `Botu Ekleyin`,
        `[Tıkla!](https://discord.com/api/oauth2/authorize?client_id=783211731279282186&permissions=8&scope=bot)`,
        true
      )
